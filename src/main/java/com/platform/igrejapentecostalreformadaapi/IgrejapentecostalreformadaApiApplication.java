package com.platform.igrejapentecostalreformadaapi;

import org.springframework.boot.SpringApplication;
import org.springframework.boot.autoconfigure.SpringBootApplication;

@SpringBootApplication
public class IgrejapentecostalreformadaApiApplication {

	public static void main(String[] args) {
		SpringApplication.run(IgrejapentecostalreformadaApiApplication.class, args);
	}
